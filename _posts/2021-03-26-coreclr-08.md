...
注意针对null的检查不会添加BasicBlock, null检查的实现机制是硬件异常, 详见[之前的文章](https://303248153.github.io/).
...
[fgComputePreds](https://github.com/dotnet/coreclr/blob/v1.1.0/src/jit/flowgraph.cpp#L3003)函数会重新计算各个block的preds(前继block), 关于preds可以参考[前一篇文章](https://303248153.github.io/coreclr-07/)中对`Flowgraph Analysis`的说明.
...
关于DOM(dominator)树请参考[前一篇文章](https://303248153.github.io/coreclr-07/)中对Flowgraph Analysis的介绍,
...
在[之前分析new的文章](https://303248153.github.io/coreclr-02/)中提到过,
...
[前一篇文章](https://303248153.github.io/coreclr-07/)介绍了标记SSA的例子, 如下:
...
- 枚举BasicBlock和BasicBlock中的语句
    - 按执行顺序枚举语句中的tree, 调用[optEarlyPropRewriteTree](https://github.com/dotnet/coreclr/blob/v1.1.0/src/jit/earlyprop.cpp#L231)
        ...
        - 对于获取对象成员并且需要检查null的节点, 如果成员的offset不超过一定值则可以去除nullcheck(因为一定会发生页错误), 在[之前的文章](https://303248153.github.io/coreclr-07/)中有提到过这个机制
...
可以参考[上一篇文章](https://303248153.github.io/coreclr-07/)关于Lowering的例子:
...
可以参考[上一篇文章](https://303248153.github.io/coreclr-07/)中说明LSRA的图片:
...
以下是[上一篇文章](https://303248153.github.io/coreclr-07/)中的图片说明:
