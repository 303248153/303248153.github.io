...
之后我们需要准备构建人脸编码数据库的人脸，也就是识别的对象，这里我为了方便测试收集了一些中国领导人的照片 (这是首先让模型认领导😤)，可以到[这里](https://github.com/303248153/303248153.github.io/tree/master/ml-13/face_recognition_samples.great_persons)下载。
