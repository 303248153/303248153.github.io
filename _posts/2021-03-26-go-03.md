...
在[前一篇](https://303248153.github.io/go-02/)中我提到了P是一个虚拟的资源, 同一时间只能有一个线程访问同一个P, 所以P中的数据不需要锁.
...
因为我之前已经对CoreCLR的GC做过分析(看[这一篇](https://303248153.github.io/coreclr-03/)和[这一篇](https://303248153.github.io/coreclr-04/)), 这里我可以简单的对比一下CoreCLR和GO的GC实现:
